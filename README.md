...
Half edge data structure, with mesh import and export. Supports materials, textures (3D uv map), flat/smooth shading and vertex normal.
...
Load Wavefront mesh into half-data:
